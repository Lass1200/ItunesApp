...
pochette, métadonnées et lien iTunes Ajout / suppression d'un élément dans une
bibliothèque personnelle Système de notation par étoiles (1 à 5) par élément

Stack technique React Native (CLI) React Navigation (native stack) iTunes Search API
— https://itunes.apple.com/search Hooks : useState, useEffect, useCallback
